    ...
    private fun updateWidgetBackground(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray, isRunning: Boolean) {
        ...
        if (isRunning) {
            if (!Utils.getDarkModeStatus(context)) {
                remoteViews.setInt(R.id.image_switch, "setImageResource", R.drawable.ic_logo)
            }
            remoteViews.setInt(
                R.id.layout_switch,
            ...
            if (!Utils.getDarkModeStatus(context)) {
                remoteViews.setInt(R.id.image_switch, "setImageResource", R.drawable.ic_launcher_foreground)
            }
            remoteViews.setInt(
                R.id.layout_switch,
                "setBackgroundResource",
